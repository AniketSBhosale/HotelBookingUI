...
export default function SuperAdminLogin({ setLogin }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (form.username == "superadmin" && form.password == "123") {
  ...
  return (
    ...
    >
      <h1 className="text-dark mb-3">Super Admin Login</h1>
      ...
      <p>
        ...
        <NavLink to="/superadminregister" className="text-primary">
          Register
        </NavLink>
      </p>
    </form>
